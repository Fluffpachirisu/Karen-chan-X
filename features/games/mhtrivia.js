...
var MHTrivia = require('./constructors.js').MHTrivia;
var RandomGenerator = require('./mhtrivia-rand.js');
...
function trans (data, room) {
	...
	return Tools.translateGlobal('games', 'mhtrivia', lang)[data];
}
...
exports.newGame = function (room, opts) {
	...
	var game = new MHTrivia(generatorOpts, parser);
	if (!game) return null;
...
exports.commands = {
	...
	endmhtrivia: function (arg, by, room, cmd, game) {
