exports.translations = {
	...
	games: {
		...
		mhtrivia: {
			'and': 'and',
			'start': 'A new **Monster Hunetr Trivia** game was created!',
			'maxgames1': 'It will be a max of',
			'maxgames2': 'games',
			'maxpoints1': 'If someone gets',
			'maxpoints2': 'points, he/she wins',
			...
			'timeout2': 'The answer was',
			'timeout3': 'The valid answers were',
			'lose': '**The Monster Hunter Trivia game ended!** But no one got any points so there are no winners',
			'end': 'The Monster Hunter Trivia game ended!',
			'grats1': 'Congratulations to',
			'grats2': 'for winning the game with',
			'points': 'points',
			'tie1': 'The result is a draw at',
			'tie2': 'between',
			'forceend1': 'The Monster Hunter Trivia game was terminated!',
			'forceend2': 'Answers'
		},
		blackjack: {
			'and': 'and',
